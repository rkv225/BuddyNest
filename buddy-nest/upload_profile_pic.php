...
<head>
<title>Buddy Nest | Upload Profile Picture</title>
...
<h5> Only JPG file with maximum size upto 850 KB</h5>
_HTML;
$a_name="profile-pics/"."$userid"."."."jpg";
if(!$_FILES)
{
...
move_uploaded_file($_FILES['filename']['tmp_name'],$a_name);
echo <<<_END
Image $name Uploaded Successfully
<br>
<img width="200" height="250" src='$a_name' / >
_END;
}
